...
def system_health():
    ...
    # --- FIXED: FETCH SUBSCRIPTION REVENUE (FROM NEW TABLE) ---
    try:
        c.execute("SELECT SUM(amount) FROM revenue_ledger")
        sub_rev_total = c.fetchone()[0] or 0.0
    ...
    # Total Lifetime = Batch Rev + Archived + Subscriptions
